...
// && !ARCH_X86_32 is fix for issue with registers count https://github.com/android-ndk/ndk/issues/693
#define HAVE_7REGS (ARCH_X86_64 || (HAVE_EBX_AVAILABLE && HAVE_EBP_AVAILABLE && !ARCH_X86_32))
